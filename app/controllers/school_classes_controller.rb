  ...
  def create
    ...
    respond_to do |format|
      if @school_class.save
        format.html { redirect_to [@school, @school_class], notice: 'School class was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @school_class.update(school_class_params)
        format.html { redirect_to [@school, @school_class], notice: 'School class was successfully updated.' }
