...
RSpec.describe ExamsController, type: :routing do
  describe 'routing' do
    it 'routes to #index' do
      expect(get: '/classrooms/1/exams').to route_to('exams#index', classroom_id: '1')
    end

    it 'routes to #new' do
      expect(get: '/classrooms/1/exams/new').to route_to('exams#new', classroom_id: '1')
    end
    ...
    it 'routes to #create' do
      expect(post: '/classrooms/1/exams').to route_to('exams#create', classroom_id: '1')
    end
