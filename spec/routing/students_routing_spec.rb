...
RSpec.describe StudentsController, type: :routing do
  describe 'routing' do
    it 'routes to #index' do
      expect(get: 'schools/1/students').to route_to('students#index', school_id: '1')
    end

    it 'routes to #new' do
      expect(get: 'schools/1/students/new').to route_to('students#new', school_id: '1')
    end
    ...
    it 'routes to #create' do
      expect(post: 'schools/1/students').to route_to('students#create', school_id: '1')
    end
